 ...
 */
public class BaseJdbcUtil2 {

    private static final Logger LOGGER = LoggerFactory.getLogger(BaseJdbcUtil2.class);

    public BaseJdbcUtil2() {
    }

    public static BaseJdbcUtil2.JdbcResult getSelect(String tableName, Class<?> entityClass, Map<String, String> entityToDbMap, Map<String, Object> criteria, Map<String, Object> notEqualCriteria) {
        ...
        BaseJdbcUtil2.JdbcResult jdbcResult = getWhereClause(tableName, criteria, notEqualCriteria);
        return jdbcResult != null ? new BaseJdbcUtil2.JdbcResult(sql.append(jdbcResult.getSql()).toString(), jdbcResult.getParams()) : new BaseJdbcUtil2.JdbcResult(sql.toString(), (Object[])null);
    }

    public static BaseJdbcUtil2.JdbcResult getSelectForCount(String tableName, Map<String, Object> criteria, Map<String, Object> notEqualCriteria) {
        StringBuilder sql = (new StringBuilder("SELECT count(*) FROM ")).append(tableName);
        BaseJdbcUtil2.JdbcResult jdbcResult = getWhereClause(tableName, criteria, notEqualCriteria);
        return jdbcResult != null ? new BaseJdbcUtil2.JdbcResult(sql.append(jdbcResult.getSql()).toString(), jdbcResult.getParams()) : new BaseJdbcUtil2.JdbcResult(sql.toString(), (Object[])null);
    }

    public static BaseJdbcUtil2.JdbcResult getSelectForSum(String tableName, String dbColumToBeSummed, Map<String, Object> criteria, Map<String, Object> notEqualCriteria) {
        StringBuilder sql = (new StringBuilder("SELECT sum(")).append(dbColumToBeSummed).append(") FROM ").append(tableName);
        BaseJdbcUtil2.JdbcResult jdbcResult = getWhereClause(tableName, criteria, notEqualCriteria);
        return jdbcResult != null ? new BaseJdbcUtil2.JdbcResult(sql.append(jdbcResult.getSql()).toString(), jdbcResult.getParams()) : new BaseJdbcUtil2.JdbcResult(sql.toString(), (Object[])null);
    }

    public static BaseJdbcUtil2.JdbcResult getInsert(String tableName, Object entity, Map<String, String> entityToDbMap) {
        ...
        if (dbMap != null && dbMap.size() > 0) {
            ...
            sql.append(")");
            return new BaseJdbcUtil2.JdbcResult(sql.toString(), params);
        } else {
            return null;
        }
    }
    ...
    public static BaseJdbcUtil2.JdbcResult getUpdate(String tableName, Object entity, Map<String, String> entityToDbMap, Map<String, Object> criteria, Map<String, Object> notEqualCriteria) {
        StringBuilder sql = new StringBuilder();
        Map<String, Object> dbMap = transferEntityToDbMap(entity, entityToDbMap);
        if (dbMap != null && dbMap.size() > 0) {
    ...
    private static BaseJdbcUtil2.JdbcResult getWhereClause(String tableName, Map<String, Object> criteria, Map<String, Object> notEqualCriteria) {
        StringBuilder sql = new StringBuilder();
        ...
        if (cirteriaSize + notEqualCriteriaSize <= 0) {
            ...
            sql.append(")");
            return new BaseJdbcUtil2.JdbcResult(sql.toString(), params.toArray());
        }
    }
    ...
    public static BaseJdbcUtil2.JdbcResult getTimeSpanJdbcResult(Date from, Date to, String column) {
        StringBuilder sql = new StringBuilder();
        List<Object> params = new ArrayList();
    ...
    public static BaseJdbcUtil2.JdbcResult getPagingJdbcResult(Date from, Date to, String column, Integer page, Integer limit) {
        BaseJdbcUtil2.JdbcResult jdbcResult = getTimeSpanJdbcResult(from, to, column);
        ...
        return new BaseJdbcUtil2.JdbcResult(sql, jdbcResult.getParams());
    }
