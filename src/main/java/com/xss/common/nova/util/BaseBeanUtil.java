...
public class BaseBeanUtil {
    ...
    public static Map<String, Object> beanToMap(Object obj) {
        ...
        try {
            ...
            log.error("将对象[{}]转换为map异常: {}", BaseJsonUtil.writeValue(obj), ExceptionUtils.getStackTrace(e));
            throw new RuntimeException(String.format("将对象[%s]转换为map异常", BaseJsonUtil.writeValue(obj)));
        }
    }
