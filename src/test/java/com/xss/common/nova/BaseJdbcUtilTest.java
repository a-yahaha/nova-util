...
public class BaseJdbcUtilTest {
    ...
    public static void init(){
        BaseJdbcUtil.defaultDbType(BaseJdbcUtil.DbType.MYSQL);
    }
    ...
    public void basicTest() {
        ...
        //insert ignore
        jdbcResult = BaseJdbcUtil.getInsertIgnore(table, user, dbMapping);
        ...
        //batch insert ignore
        jdbcResult = BaseJdbcUtil.getBatchInsertIgnore(table, Arrays.asList(user, user2), dbMapping);
        assertThat(jdbcResult.getSql(), equalToIgnoringCase("insert ignore into t_user (`id`,`name`,`age`,`last_update_at`) values (?,?,?,?)"));
        ...
        jdbcResult = BaseJdbcUtil.getSelect(table, Criteria.column("age").eq(20), pageRequest);
        ...
        //db row to entity
        UserEntity userEntity = BaseJdbcUtil.dbRowToEntity(ImmutableMap.of("id", "123", "name", "wyb", "age", 20, "last_update_at",
    ...
    public void testUsingDb() {
        ...
        user1.setId(BaseStringUtil.uuidSimple());
        user1.setName("wyb");
        user1.setAge(33);
        ...
        user3.setId(BaseStringUtil.uuidSimple());
        user3.setName("lll");
        user3.setAge(30);
        ...
        //使用ignore再次插入重复主键数据
        jdbcResult = BaseJdbcUtil.getInsertIgnore(table, user1, dbMapping);
        ...
        //根据条件查询多条数据
        jdbcResult = BaseJdbcUtil.getSelect(table, Criteria.column("age").gt(4));
        ...
        dbRows.forEach(dbResult -> {
            UserEntity entity = BaseJdbcUtil.dbRowToEntity(dbResult, dbMapping, UserEntity.class);
        ...
        //分页查询, 升序
        jdbcResult = BaseJdbcUtil.getSelect(table, (Criteria) null, PageRequest.of(2, 2).orderBy("last_update_at", PageRequest.Order.ASC));
        dbRows = template.queryForList(jdbcResult.getSql(), jdbcResult.getParams());
        ...
        user4.setId(BaseStringUtil.uuidSimple());
        user4.setName("wyb");
        user4.setAge(28);
        user4.setLastModifyTime(new Date());
        jdbcResult = BaseJdbcUtil.getInsertOrUpdate(table, user4, dbMapping);
