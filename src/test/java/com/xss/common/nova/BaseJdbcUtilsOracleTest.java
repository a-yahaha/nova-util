...
@Slf4j
public class BaseJdbcUtilsOracleTest {
    ...
    public static void init(){
        BaseJdbcUtils.defaultDbType(BaseJdbcUtils.DbType.ORACLE);
    }
    ...
    public void basicTestForOracle() {
        ...
        //db row to entity
        UserEntity userEntity = BaseJdbcUtils.dbRowToEntity(ImmutableMap.of("id", "123", "name", "wyb", "age", new BigDecimal(20), "last_update_at",
    ...
    public void testForVerify() {
        ...
        row = template.update(jdbcResult.getSql(), jdbcResult.getParams());
        assertTrue(row == 1);
        jdbcResult = BaseJdbcUtils.getSelect(table, Criteria.column("id").eq(user1.getId())); //查询并校验
